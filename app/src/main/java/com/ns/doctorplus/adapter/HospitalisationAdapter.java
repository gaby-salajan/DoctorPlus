...
public class HospitalisationAdapter  extends FirestoreRecyclerAdapter<File,HospitalisationAdapter.FicheHolder2> {

    public HospitalisationAdapter(@NonNull FirestoreRecyclerOptions<File> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull FicheHolder2 holder, int position, @NonNull final File model) {
